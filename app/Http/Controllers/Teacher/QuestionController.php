...
class QuestionController extends Controller
{
    ...
    public function all_question(){
        ...
        $questions = Question::latest()->approved()->published()->paginate(6);
        $tags = Tag::all();
        return view('teacher.question.all_question',compact('questions','tags'));
    }
     ...
     public function question_details($slug){
        ...
        return view('teacher.question.question_details', compact('questions'));
    }
     ...
     public function questionBySubject($slug)
    {
        ...
        return view('teacher.question.subject_question',compact('tag','questions'));
    }
