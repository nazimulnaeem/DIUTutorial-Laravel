                                        ...
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="image">
                                                        <img class="media-object image-circle" src="{{asset('images/profile/'. $comment->user->image )}}" width="48" height="48" alt="User">
                                                    </div>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a target="_blank" href="{{ route('student.post_details',$comment->post->slug) }}">
