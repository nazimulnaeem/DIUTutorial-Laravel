            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                ...
                <div class="info-box bg-blue-grey hover-zoom-effect">
                 ...
                 <div class="info-box bg-orange hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $question_count }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
                <div class="info-box bg-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $teacher_count }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
                <div class="info-box bg-deep-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">TODAY TEACHER</div>
                        <div class="number count-to" data-from="0" data-to="{{ $new_teacher_today }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach($popular_posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary waves-effect" target="_blank" href="{{ route('admin.post.show',$post->id) }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <tr>
                                 ...
                                 <tbody>
                                    @foreach($active_teacher as $key=>$teacher)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $teacher->name }}</td>
                                            <td>{{ $teacher->posts_count }}</td>
                                            <td>{{ $teacher->comments_count }}</td>
                                            <td>{{ $teacher->favorite_posts_count }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
