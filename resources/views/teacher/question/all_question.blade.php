            ...
            <div class="swiper-wrapper">
               ...
               @foreach($tags as $tag)
                    <div class="swiper-slide">
                        <a class="slider-tag" href="{{ route('teacher.view.question',$tag->slug) }}">
...
<!--                                    <h4 class="title"><a href="{{ route('student.question_details',$question->slug) }}"><b>{{ $question->title }}</b></a></h4>-->
                                    ...
                                    @endforeach
                                    <h3> <a href="{{ route('teacher.question_details',$question->slug) }}"><b>{{ $questionTag->name }}</b></a></h3>
                                    <h4><a href="{{ route('teacher.question_details',$question->slug) }}"> {{ $question->course_code }}</a></h4>
                                    <a href="{{ route('teacher.question_details',$question->slug) }}"> {{ $question->passing_year }}</a>
