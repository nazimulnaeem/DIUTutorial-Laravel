                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <h4 class="title"><a href="{{ route('teacher.post_details',$post->slug) }}">{{ $post->title }}</a></h4>
                                     @foreach($tags as $tag)
                                        ...
                                        <h5><a href="{{ route('teacher.post_details',$post->slug) }}">Subject : <b>{{ $postTag->name }}</b></a></h5>
