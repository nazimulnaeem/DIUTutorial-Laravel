            ...
            <div class="swiper-wrapper">
               ...
               @foreach($tags as $tag)
                    <div class="swiper-slide">
                        <a class="slider-tag" href="{{ route('teacher.view.subject',$tag->slug) }}">
                            <div class="blog-image"><img src="{{ asset('images/viewPage/content1.jpg') }}" alt="{{ $tag->name }}"></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ asset('images/classroomImage/default/classr.jpg') }}" alt="{{ $post->title }}"></div>
