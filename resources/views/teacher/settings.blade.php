                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="javascript:void(0);" class=" waves-effect waves-block">Teacher action</a></li>
                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="row clearfix">
                                     ...
                                     <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="designation" class="form-control" placeholder="Enter your designation" name="designation" value="{{ Auth::user()->designation }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                <form method="POST" action="{{ route('teacher.password.update') }}" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
