                            ...
                            <div class="card h-100">
                                ...
                                <a class="avatar" href=""><img src="{{asset('images/profile/'.\App\Models\User::where('id',$question->user_id)->first()->image)}}" alt="Profile Image"></a>
                                    ...
                                    <div class="blog-info">
                                        ...
                                        <h4 class="title"><a href="{{ route('student.question_details',$question->slug) }}"><b>{{ $question->title }}</b></a><br>
                                       <a href="{{ route('student.question_details',$question->slug) }}">{{ $question->term }}</a><br>
                                        <a href="{{ route('student.question_details',$question->slug) }}">{{ $question->passing_year }}</a></h4>
