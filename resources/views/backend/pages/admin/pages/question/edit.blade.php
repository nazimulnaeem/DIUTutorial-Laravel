    ...
    <div class="content-wrapper">
        ...
        <div class="card col-md-7">
            ...
            <div class="card-body px-lg-5 ">
                   ...
                   <!-- Form -->
                <form class="" style="color: #757575;" method="post" action="{{ route('question.update',$question->id) }}" enctype="multipart/form-data">
...
<!--                     for error show -->
                 ...
                 <div class="form-group">
                     <label for="sname" class="form-control-label" style="color: black; font-size: 18px;">Subject Name</label>
                                <input type="text" name="subject_name" class="form-control" value="{{ $question->subject_name }}">
                            </div>
                             <div class="form-group">
                                <label for="course_code" class="form-control-label" style="color: black; font-size: 18px;">Course Code</label>
                                <input type="text" name="course_code" class="form-control" value="{{ $question->course_code }}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="8" cols="40">{!! $question->description !!}</textarea>
                    </div>
